...
fn test_consistency() {
    ...
    let mut life_hash = ConwayFieldHash256::blank(N.ilog2());
    ...
    let (mut cells_simd, mut cells_hash) = (Vec::with_capacity(N * N), Vec::with_capacity(N * N));
    for y in 0..N {
        for x in 0..N {
